...
@router.get(
    ...
    description="Get list of ongoing anime series"
)
@router.get(
    "/ongoing/{page}",
    response_model=BaseResponse[AnimeListResponse],
    summary="Ongoing Anime with Page",
    description="Get list of ongoing anime series with pagination"
)
async def get_ongoing_anime(
    page: str = "1",
